        ...
        <table class="table table-hover align-middle mb-0 agm-table">
            <thead class="table-light">
                <tr>
                    ...
                    <th class="agm-col-date">Data</th>
                    <th class="agm-col-time text-center">Val.</th>
                    <th class="agm-col-time text-center">Min.</th>
                    <th class="agm-col-team">Šeimininkai</th>
                    <th class="agm-col-team">Svečiai</th>
                    <th class="agm-col-event">Etapas</th>
                    @if(session('admin') >= 9)
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <button type="submit" name="delete" value="1"
                                class="btn btn-sm btn-outline-secondary ag-action-btn ag-action-delete"
