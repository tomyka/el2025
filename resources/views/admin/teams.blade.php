...
<div class="sb-card">
    ...
    <form method="post" action="{{route('admin.teams')}}">
            ...
            <div class="col-md-1 d-none d-lg-block text-center">Grupė</div>
                <div class="col-md-3 d-none d-lg-block text-center">Nuoroda</div>
                <div class="col-md-1 col-2 text-center">Vieta</div>
                <div class="col-md-1 col-1 text-center">Šešiolikfinalis</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-1 d-none d-lg-block"><input type="text" class="form-control form-control-sm"  name="link[{{$team->id}}]" value="{{$team->link}}"></div>
                ...
                <div class="col-md-1 table-cell text-center">
                    <div class="form-check form-switch d-flex align-items-center justify-content-center">
                        <input type="checkbox" class="form-check-input" name="last32[{{$team->id}}]" {{(($team->last32==1)?"checked":"")}}>
                    </div>
                </div>
                <div class="col-md-1 table-cell text-center">
                    <div class="form-check form-switch d-flex align-items-center justify-content-center">
