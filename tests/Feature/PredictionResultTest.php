...
class PredictionResultTest extends TestCase
{
    ...
    public function test_multiple_users_can_predict_same_game(): void
    {
        ...
        PredictionResult::create(['user_id' => $user1->id, 'game_id' => $game->id, 'home_team_score' => 1, 'away_team_score' => 1]);
        PredictionResult::create(['user_id' => $user2->id, 'game_id' => $game->id, 'home_team_score' => 2, 'away_team_score' => 0]);
    ...
    public function test_user_can_update_prediction_before_game(): void
    {
        ...
        $prediction->update(['home_team_score' => 2, 'away_team_score' => 1]);
